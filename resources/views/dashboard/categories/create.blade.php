...
<div id="kt_app_content_container" class="app-container container-xxl">
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_account_profile_details_form" class="form" action="{{ route('categories.store') }}" method="post">
                @csrf
                ...
                <div class="card-body border-top p-9">
                    ...
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-form.input name="name" lable="Category Name" placeholder="Category Name" />
                    ...
                    <div class="row mb-6">
                        ...
                        <textarea class="form-control form-control-lg" name="desc" id="" cols="30" rows="10"> {{ old('desc') }} </textarea>
                        </div>
                        @if ($errors->has('desc'))
