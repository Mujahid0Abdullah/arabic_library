...
<head>
	...
	<!-- Color CSS -->
	<link rel="stylesheet" href="{{ asset('front/css/color/color1.css') }}">
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color2.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color3.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color4.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color5.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color6.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color7.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color8.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color9.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color10.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color11.css') }}">-->
	<!--<link rel="stylesheet" href="{{ asset('front/css/color/color12.css') }}">-->
...
<body class="js">
	...
	<div class="color-plate ">
		...
		<h4>Eshop Colors</h4>
		<p>Here is some awesome colors available on Eshop Template.</p>
					...
					<div class="col-lg-4 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								...
								<li><i class="ti-email"></i> support@.com</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar shopping">
								<a href="#" class="single-icon"><i class="ti-bag"></i> <span class="total-count">{{$cartItems->count()}}</span></a>
								<!-- Shopping Item -->
								<div class="shopping-item">
									...
									<ul class="shopping-list">
										...
										@else
											...
											<p class="quantity">{{ $item->quantity }} adet - <span class="amount">${{ $item->book->price }}</span></p>
										</li>
											@endforeach
										@endif
										<li>
